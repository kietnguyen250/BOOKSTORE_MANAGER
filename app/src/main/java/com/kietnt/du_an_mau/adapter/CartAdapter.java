...
import static com.kietnt.du_an_mau.HoaDonChiTietActivity.rcv_hdct;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public CartAdapter(Context context, ArrayList<HoaDonChiTiet> list_hdct){
    ...
    public void capnhatHoaDon(){
        ...
        list_hdct = hoaDonChiTietDAO.getAllHoaDonChiTiet();
        cartAdapter = new CartAdapter(context, list_hdct);
